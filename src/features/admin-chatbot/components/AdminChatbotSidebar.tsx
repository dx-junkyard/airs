...
import useAdminChatbot from '@/features/admin-chatbot/hooks/useAdminChatbot';
import AdminChatbotMessageList from './AdminChatbotMessageList';
import AdminChatbotInput from './AdminChatbotInput';
 ...
 * 管理者チャットボットサイドバー
 *
 * 左下のフローティングボタンとスライドインするサイドバーチャット
 */
export const AdminChatbotSidebar: React.FC = () => {
  const {
    isOpen,
    messages,
    input,
              ...
              {!isChatStarted ? (
                ...
                `}>
                  <SuggestedQuestionsEmptyState
                    ...
                    title="ヘルプアシスタント"
                    description="システムの使い方について質問できます"
...
export default AdminChatbotSidebar;
