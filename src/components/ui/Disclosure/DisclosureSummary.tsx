...
const DisclosureSummary = (props: DisclosureSummaryProps) => {
  const { children, className, ...rest } = props;

  return (
    <summary
      className={`
        group/summary flex w-fit cursor-default list-none items-start
        justify-start gap-2
    ...
    >
      <svg
        aria-hidden={true}
        className={`
          mt-[calc((1lh-24px)/2)] flex-none text-blue-1000
