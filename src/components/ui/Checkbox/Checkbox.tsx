...
const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>((props, ref) => {
  ...
  const checkbox = (
    <span
      className={`
        flex shrink-0 items-center justify-center rounded-[calc(1/8*100%)]
    ...
    >
      <input
        className={`
          size-3/4 appearance-none rounded-[calc(2/18*100%)]
          border-solid-gray-600 bg-white bg-clip-padding
          ...
          indeterminate:border-blue-900 indeterminate:bg-blue-900
          indeterminate:before:block
          indeterminate:before:[clip-path:path('M3.25,7.75H10.75V6.25H3.25V7.75Z')]
          hover:border-black
          checked:hover:border-blue-1100 checked:hover:bg-blue-1100
          indeterminate:hover:border-blue-1100 indeterminate:hover:bg-blue-1100
          ...
          data-error:border-error-1 data-error:checked:bg-error-1
          data-error:indeterminate:bg-error-1 data-error:hover:border-red-1000
          data-error:checked:hover:bg-red-1000
  ...
  return children ? (
    ...
    >
      ...
      <span
        className={`
          data-[size=sm]:text-dns-16N-130 data-[size=sm]:pt-px
          data-[size=md]:text-dns-16N-130 data-[size=md]:pt-1
          data-[size=lg]:text-dns-17N-130 data-[size=lg]:pt-2.5
          text-solid-gray-800
        `}
        data-size={size}
      >
