...
import type { SeparatedDatePickerSize } from '@/components/ui/SeparatedDatePicker/SeparatedDatePicker';
...
const SeparatedDatePickerCalendarButton = forwardRef<
  HTMLButtonElement,
...
>((props, ref) => {
  ...
  return (
    <button
      className={`
        group rounded-6 flex h-14 items-center justify-center gap-x-1 border
        border-blue-900 bg-white px-3 text-blue-900
        hover:border-[calc(3/16*1rem)] hover:px-2.5
...
export default SeparatedDatePickerCalendarButton;
