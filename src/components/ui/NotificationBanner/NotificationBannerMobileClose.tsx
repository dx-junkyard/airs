...
export type NotificationBannerMobileCloseProps = ComponentProps<'button'>;

const NotificationBannerMobileClose = (
  props: NotificationBannerMobileCloseProps
) => {
  ...
  return (
    <button
      className={`
        rounded-4 mt-1 touch-manipulation self-start text-solid-gray-900
        hover:bg-solid-gray-50 hover:outline-1 hover:outline-solid
...
export default NotificationBannerMobileClose;
