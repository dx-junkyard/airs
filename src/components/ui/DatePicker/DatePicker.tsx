...
const DatePicker = (props: DatePickerProps) => {
  ...
  return (
    ...
    <div
      className={`
        rounded-8 inline-flex h-14 -space-x-1 border border-solid-gray-600
        bg-(--bg) p-0.5 pe-0 text-solid-gray-900
        [--bg:theme(colors.white)]
        focus-within:border-black
        hover:border-solid-gray-900
        data-disabled:border-solid-gray-300 data-disabled:text-solid-gray-420
        data-disabled:[--bg:theme(colors.solid-gray.50)]
        data-error:border-error-1 data-error:focus-within:border-red-1000
        data-error:hover:border-red-1000
        data-readonly:border-dashed
        hover:data-readonly:border-solid-gray-600
        data-error:hover:data-readonly:border-error-1
        data-[size=md]:h-12
        data-[size=sm]:h-10
        forced-colors:data-disabled:border-[GrayText]
