...
const Radio = forwardRef<HTMLInputElement, RadioProps>((props, ref) => {
  ...
  const radio = (
    ...
    >
      <input
        className={`
          size-5/6 appearance-none rounded-full border-solid-gray-600 bg-white
          before:hidden before:size-full before:bg-white
          before:[clip-path:circle(calc(5/16*100%))]
          checked:border-blue-900 checked:before:block
          checked:before:bg-blue-900
          hover:border-black
          checked:hover:border-blue-1100 checked:hover:before:bg-blue-1100
          ...
          data-error:border-error-1 data-error:checked:before:bg-error-1
